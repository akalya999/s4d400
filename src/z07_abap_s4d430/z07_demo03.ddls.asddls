...

{
  ...
  key c.connection_id                                          as ConnectionId,
      ...
      'Hello World'                                            as TextLiteral, // 40 mal ausgegeben mit nur einer spalte, da connection / flight gejoined & ins 40 Flüge
      42                                                       as NumberLiteral,
      0.1                                                      as Fltp,
      ...
      f.seats_occupied / f.seats_max                           as OccupancyRate, // so nicht teilen
      ...
      case f.currency_code when 'EUR' then 'Euro'
                           ...
                           when 'USD' then 'Amerikanische Dollar'
                           else 'was anderes'
      ...
      length('   ')                                            as SSS, // Leerzeichen anzahl immer gleich wert
      length('  X')                                            as SSX,
      length('X  ')                                            as XSS,
